...
ASSET_ID_RE = re.compile(r'^[a-z0-9][a-z0-9._-]*ALLOWED_KINDS = {'skin', 'portrait', 'concept-art', 'variation'}
...
SHA256_RE = re.compile(r'^[0-9a-f]{64}ALLOWED_KINDS = {'skin', 'portrait', 'concept-art', 'variation'}
