...
- Visual and asset runtime/authoring authority (Repo Textura domain): `art/` in this repository.
- Visual/presentation planning authority: `plans/textura/`.
