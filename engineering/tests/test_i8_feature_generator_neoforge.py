...
class I8NeoForgeSkeletonContractTest(unittest.TestCase):
    ...
    def test_registry_surface_uses_neoforge_deferred_registers_for_generated_features(self):
        ...
        self.assertIn("BLOCKS.registerBlock(", source)
        self.assertIn('"copper_machine", CopperMachineBlock::new', source)
        self.assertIn("ITEMS.registerItem(", source)
        self.assertIn('"copper_gear", CopperGearItem::new', source)
