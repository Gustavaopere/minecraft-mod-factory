...
const EXPECTED_FILES = new Set([
  ...
  'model-asset/provider-regression/geckolib4/REFERENCE-EVIDENCE.json',
  'model-asset/provider-regression/geckolib4/factory-test.animation.json',
  'model-asset/provider-regression/geckolib4/factory-test.geo.json',
  'model-asset/provider-regression/azurelib3/REFERENCE-EVIDENCE.json',
  'model-asset/provider-regression/azurelib3/factory-test.animation.json',
  'model-asset/provider-regression/azurelib3/factory-test.geo.json',
