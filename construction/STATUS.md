...
BLOCKERS=NONE
NEXT_ACTION=OBTAIN_EXPECTED_RED_THEN_IMPLEMENT_C0_VALIDATOR
...
- [ ] authority documentation exists
- [ ] architecture document exists
- [ ] upstream registry validates
- [ ] schemas parse and satisfy C0 invariants
- [ ] contract tests pass
- [ ] C0 validator passes
