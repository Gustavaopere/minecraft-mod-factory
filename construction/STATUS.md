...
PHASE=C1_SCHEMATICA_PRESERVATION_IMPLEMENTED_PENDING_GREEN
...
BLOCKERS=NONE
NEXT_ACTION=RUN_C1_GREEN_GATES_ON_EXACT_GITLINK_HEAD
...
- [x] `.gitmodules` contract materialized
- [x] gitlink requested with mode `160000`
- [x] gitlink requested at audited upstream pin
- [ ] GitHub tree confirms exact gitlink
